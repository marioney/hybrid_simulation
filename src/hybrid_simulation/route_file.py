...
def generate_route_file_dmaking(route_file_path, n_scenario):
    ...
    with open(route_file_path, "w") as routes:
        ...
        if n_scenario == 4:
            ...
            print('    <vehicle id="car_17" type="Car_70" route="route02" depart="3" />', file=routes)
            print('    <vehicle id="car_18" type="Car_80" route="route03" depart="3" />', file=routes)
            print('    <vehicle id="car_19" type="Car_100" route="route04" depart="3" />', file=routes)
            print('    <vehicle id="car_20" type="Car_130" route="route05" depart="3" />', file=routes)
            print('    <vehicle id="car_21" type="Car_130" route="route03" depart="3" />', file=routes)
            print('    <vehicle id="car_22" type="Car_130" route="route03" depart="3" />', file=routes)
            print('    <vehicle id="car_23" type="Car_70" route="route04" depart="4" />', file=routes)
            print('    <vehicle id="car_24" type="Car_80" route="route05" depart="4" />', file=routes)
            print('    <vehicle id="car_25" type="Car_100" route="route02" depart="4" />', file=routes)
            print('    <vehicle id="car_26" type="Car_130" route="route03" depart="4" />', file=routes)
            print('    <vehicle id="car_27" type="Car_130" route="route04" depart="4" />', file=routes)
            print('    <vehicle id="car_28" type="Car_130" route="route05" depart="4" />', file=routes)
            print('    <vehicle id="car_29" type="Car_70" route="route02" depart="5" />', file=routes)
            print('    <vehicle id="car_30" type="Car_80" route="route03" depart="5" />', file=routes)
            print('    <vehicle id="car_31" type="Car_100" route="route04" depart="5" />', file=routes)
            print('    <vehicle id="car_32" type="Car_130" route="route05" depart="5" />', file=routes)
        if n_scenario == 5:
